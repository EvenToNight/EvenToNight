...
//              - **single versioning and changelog** for the whole product.
            items: [
                { text: "Introduction", link: "/introduction" },// due robe su semantic versioning e come vengono versionate le immagini docker + dev pre release + perche abbiamo scelto gpl invece che le altre (apache/mit)
                ...
                { text: "Translation Action and CLI tool", link: "/translation-action-and-cli-tool" }, //io
