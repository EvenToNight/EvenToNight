...
\begin{itemize}
  ...
  \item \textbf{Branch convention}: all branches follow the \href{https://conventionalbranch.org/}{\textbf{Conventional Branch}} specification (prefixed \texttt{feature/}, \texttt{refactor/}, \texttt{ci/}, \texttt{docs/}).
\end{itemize}
