...
tasks.register("runCoverage") {
    description = "Run coverage analysis for Notifications service"
    group = "verification"
    dependsOn("testWithCoverage")

    doLast {
        println("✅ Notifications service coverage completed!")
        println("📋 Report available at: services/notifications/coverage")
    }
}
