...
class UtilsSpec extends AnyFlatSpec with Matchers:
  ...
  it should "return Right(()) on 201 response" in {
    ...
    server.createContext("/internal/events/1", new HttpHandler {
  ...
  it should "handle unauthenticated requests by defaulting to PUBLISHED or matching passed statuses" in {
    val cmd = Utils.parseEventFilters(
      limit = None, offset = None, status = Some(List("DRAFT")), title = None, tags = None, startDate = None, 
      endDate = None, organizationId = None, city = None, location_name = None, sortBy = None,
      sortOrder = None, query = None, near = None, other = None, price = None, isAuthenticated = false
    )
    cmd.status shouldBe Some(List(EventStatus.DRAFT))
  ...
  it should "handle badly formed dates on parseEventFilters" in {
    val cmd = Utils.parseEventFilters(
      limit = None, offset = None, status = None, title = None, tags = None, startDate = Some("bad-date"), 
      endDate = Some("bad-date"), organizationId = None, city = None, location_name = None, sortBy = Some("invalid-sort"),
      sortOrder = Some("invalid-order"), query = None, near = None, other = None, price = None, isAuthenticated = true
    )
  ...
  it should "handle authenticated requests with no status provided seamlessly" in {
    val cmd = Utils.parseEventFilters(
      limit = None, offset = None, status = None, title = None, tags = None, startDate = None, 
      endDate = None, organizationId = None, city = None, location_name = None, sortBy = None,
      sortOrder = None, query = None, near = None, other = None, price = None, isAuthenticated = true
    )
