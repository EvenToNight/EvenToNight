...
import application.mapper.MemberUpdater
import application.mapper.OrganizationUpdater
import application.utils.UserQueryParser
...
import presentation.http.dto.request.query.SearchUsersQueryDTO
import presentation.http.dto.request.update.UpdatePasswordRequestDTO
import presentation.http.dto.request.update.UpdateUserRequestDTO
import presentation.http.dto.response.query.PaginatedResponseDTO
import presentation.http.dto.response.user.AvatarResponseDTO
import presentation.http.mappers.UserMappers.toUserDTO
import presentation.http.security.HttpSecurity.authenticateAndAuthorize
        ...
        val result: Either[String, RegisteredUser] =
          for
            ...
            updatedUser <- user match
              case m: Member       => MemberUpdater.updateFromDTO(m, dto)
              case o: Organization => OrganizationUpdater.updateFromDTO(o, dto)
