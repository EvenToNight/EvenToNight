...
object DockerCommands {
    ...
    const val TEARDOWN_TICKETING_ENVIRONMENT = "$TEARDOWN_APPLICATION_ENVIRONMENT -eP services/ticketing --project-name eventonight-ticketing-environment"
    ...
    const val SETUP_TICKETING_ENVIRONMENT = "$SETUP_APPLICATION_ENVIRONMENT -eP services/ticketing --project-name eventonight-ticketing-environment"
}
